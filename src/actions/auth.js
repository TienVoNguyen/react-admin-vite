...
export function loginUser(creds) {
  return (dispatch) => {
    ...
    if (creds.social) {
      ...
      console.log('🚀 Making login request to:', axios.defaults.baseURL + '/auth/signin/local');
      console.log('📧 Credentials:', { email: creds.email, password: '***' });
      axios
        ...
        .catch((err) => {
          ...
          dispatch(authError(err.response?.data || err.message));
        });
    } else {
